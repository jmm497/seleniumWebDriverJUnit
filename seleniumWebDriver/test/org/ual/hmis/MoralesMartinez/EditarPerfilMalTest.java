...
import java.net.URL;
public class EditarPerfilMalTest {
  ...
  public void editarPerfilMal() {
    ...
    driver.findElement(By.id("Input_NewEmail")).sendKeys("aaa");
    {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".pb-3"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).release().perform();
    }
    driver.findElement(By.cssSelector("html")).click();
    ...
    assertThat(driver.findElement(By.cssSelector(".text-danger li")).getText(), is("The New email field is not a valid e-mail address."));
