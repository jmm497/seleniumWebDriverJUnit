...
public class LoginBienTest {
  ...
  public void loginBien() {
    ...
    assertThat(driver.findElement(By.cssSelector(".display-4")).getText(), is("Welcome"));
    assertThat(driver.findElement(By.cssSelector(".btn")).getText(), is("Logout"));
